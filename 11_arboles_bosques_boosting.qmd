...
2. Calculamos la función de pérdida como función de $\alpha$, cortando hojas para obtener el mejor subárbol para cada valor de $\alpha$.
...
1. Tomamos un subconjunto aleatorio con reemplazo de los datos del mismo tamaño del conjunto original.
...
El boosting tiende a sobreajustarse a los datos, tal que es necesario tener cuidado con el proceso de entrenamiento y elección de hiperparámetros.
