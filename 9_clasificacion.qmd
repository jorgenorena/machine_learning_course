...
$$
Ahora la ecuación es cuadrática. Esto es más general que el caso anterior, pero requiere estimar el término cuadrático. Este término contiene la matriz $\Sigma^{-1}$  que contiene $p(p - 1)/2$ elementos por cada clase. Esto quiere decir que necesitamos más datos en general para que funcione bien.
