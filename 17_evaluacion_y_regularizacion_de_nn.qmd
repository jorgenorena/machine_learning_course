...
![Error de generalización para el ajuste de un polinomio de Legendre en función del grado.](figs/double_descent_polynomial.png){#fig-double-descent-polynomial width=50%}

Sin embargo, se ha observado que para ciertos modelos, el error de generalización puede disminuir con el aumento del número de parámetros. Un ejemplo se puede ver en la figura @fig-double-descent-polynomial, donde he graficado el error de prueba para el ajuste de un polinomio de Legendre en función del grado (sacado de mi solución a uno de los [proyectos](proyectos)). Esto se llama "descenso doble" (double descent). Es decir, el error de generalización tiene tres regiones:
