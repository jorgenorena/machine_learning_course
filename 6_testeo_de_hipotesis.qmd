...
La región de exclusión $R_k$ de todos los puntos tal que $\lambda < k$ dado un $\alpha = \int_{R_k} d^nx\,L(\theta_0)$ es la que maximiza $\beta = \int_{R_k}d^nx\,L(\theta_a)$.
:::
